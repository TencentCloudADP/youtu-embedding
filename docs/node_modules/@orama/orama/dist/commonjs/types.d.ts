...
export interface SearchParamsFullText<T extends AnyOrama, ResultDocument = TypedDocument<T>> extends SearchParamsBase<T, ResultDocument> {
     ...
     *
     * Full documentation: https://docs.orama.com/docs/orama-js/search/bm25
     *
     ...
     *
     * Full documentation: https://docs.orama.com/docs/orama-js/search/fields-boosting
     *
     * @example
     ...
     * Full documentation: https://docs.orama.com/docs/orama-js/search/facets
     *
     ...
     * Full documentation: https://docs.orama.com/docs/orama-js/search#distinct
     *
     * @example
     * const results = await search(db, {
     *  term: 'Headphones',
     ...
     * Full documentation: https://docs.orama.com/docs/orama-js/search/grouping
     *
     * @example
     * const results = await search(db, {
     *  term: 'Headphones',
     ...
     * Full documentation: https://docs.orama.com/docs/orama-js/search/filters
     *
     * @example
     ...
     *
     * Full documentation: https://docs.orama.com/docs/orama-js/search/threshold
     *
     * @example
     *
     * const result = await search(db, {
     ...
     *
     * Full documentation: https://docs.orama.com/docs/orama-js/search/preflight
     *
     * @example
     *
     * const result = await search(db, {
...
export interface SearchParamsHybrid<T extends AnyOrama, ResultDocument = TypedDocument<T>> extends SearchParamsBase<T, ResultDocument> {
     ...
     * Full documentation: https://docs.orama.com/docs/orama-js/search/hybrid-search
     */
